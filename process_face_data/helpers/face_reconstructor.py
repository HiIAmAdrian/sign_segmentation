...
INPUT_CSV_DIR = "output_landmarks_csv_p2_occlusion_normalised"
INPUT_CSV_PATTERN = "sentence_008_mediapipe_landmarks_py_oneeuro_smoothed_filled_ransac.csv"

OUTPUT_VIDEO_FILENAME = "face_reconstruction_output/face_reconstruction_all_sentences_video-p2.mp4"
FPS = 60
PLOT_POINT_SIZE = 2
